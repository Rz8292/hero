...
<section class="pt-20 pb-12 lg:pt-[120px] lg:pb-[90px] dark:bg-dark" id='services'>
   <div class="container mx-auto">
      <div class="-mx-4 flex flex-wrap">
         <div class="w-full px-4">
            <div class="mx-auto mb-12 max-w-[510px] text-center lg:mb-20">
               ...
               <h2
                  class="text-dark dark:text-black mb-3 text-3xl leading-[1.2] font-bold sm:text-4xl md:text-[40px]"
                  >
                  What We Offer
               </h2>
               <p class="text-body-color text-base dark:text-dark-6">
                  There are many service provided to the multiple companies
               </p>
            </div>
         </div>
      </div>
      <div class="-mx-4 flex flex-wrap">
         <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            <div
               class="mb-9 rounded-[20px] shadow-lg bg-white dark:bg-dark-2 p-10 shadow-2 hover:shadow-lg md:px-7 xl:px-10"
               >
               <div
                  class="bg-[blue] mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl"
                  >
                 <svg
                 width="36"
                  height="36"
                ...
                >
    <path
      d="M18 1C8.61116 1 1 8.61116 1 18C1 27.3888 8.61116 35 18 35C27.3888 35 35 27.3888 35 18C35 8.61116 27.3888 1 18 1ZM18 3C26.2843 3 33 9.71573 33 18C33 26.2843 26.2843 33 18 33C9.71573 33 3 26.2843 3 18C3 9.71573 9.71573 3 18 3ZM13.2929 11.7071C12.9024 11.3166 12.9024 10.6834 13.2929 10.2929C13.6834 9.90237 14.3166 9.90237 14.7071 10.2929L20.7071 16.2929C21.0976 16.6834 21.0976 17.3166 20.7071 17.7071L14.7071 23.7071C14.3166 24.0976 13.6834 24.0976 13.2929 23.7071C12.9024 23.3166 12.9024 22.6834 13.2929 22.2929L18.5858 17L13.2929 11.7071ZM22.2929 11.7071C21.9024 11.3166 21.9024 10.6834 22.2929 10.2929C22.6834 9.90237 23.3166 9.90237 23.7071 10.2929L29.7071 16.2929C30.0976 16.6834 30.0976 17.3166 29.7071 17.7071L23.7071 23.7071C23.3166 24.0976 22.6834 24.0976 22.2929 23.7071C21.9024 23.3166 21.9024 22.6834 22.2929 22.2929L27.5858 17L22.2929 11.7071Z"
      fill="white"
    />
  </svg>
               </div>
               <h4 class="text-dark dark:text-black mb-[14px] text-2xl font-semibold">
                  Website Development
               </h4>
               <p class="text-body-color dark:text-dark-6">
               We specialize in creating responsive and user-friendly websites tailored to your business needs.
               </p>
            </div>
         </div>
         <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            <div
               ...
               >
               <div
                  class="bg-[blue] shadow-lg mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl"
                  >
                  <svg 
                     width="36" 
                     height="36" 
               ...
               <p class="text-body-color dark:text-dark-6">
               Crafting intuitive interfaces and engaging user experiences to elevate your digital presence.
               </p>
            </div>
         </div>
         <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            <div
               ...
               <p class="text-body-color dark:text-dark-6">
               Providing insightful data analysis and strategic insights to drive informed business decisions
               </p>
            </div>
         </div>
         <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            <div
               ...
               <p class="text-body-color dark:text-dark-6">
               Crafting effective digital strategies and campaigns to enhance online presence and drive business growth.
               </p>
            </div>
         </div>
         <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            <div
               ...
               <p class="text-body-color dark:text-dark-6">
               Providing expert guidance and strategic solutions to help businesses achieve their goals and navigate challenges.
               </p>
            </div>
         </div>
         <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            <div
               class="mb-9 rounded-[20px] bg-white dark:bg-dark-2 p-10 shadow-lg shadow-2 hover:shadow-lg md:px-7 xl:px-10"
               >
               <div
                  class="bg-[blue] mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl"
                  >
               ...
               <p class="text-body-color dark:text-dark-6">
               Building innovative mobile applications tailored to meet your business needs and engage your users
               </p>
            </div>
         </div>
      </div>
