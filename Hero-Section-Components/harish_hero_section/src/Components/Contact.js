  ...
  return (
        ...
        <div class="flex items-stretch justify-center">
            <div class="grid md:grid-cols-2">
                <div class="h-full pr-6">
                    ...
                    We are here to assist you! Share your feedback by filling out the form below or reach out to us with any queries via email. Our team is dedicated to addressing your needs promptly and ensuring your experience with us is seamless. Thank you for choosing us as your partner.
                    </p>
    ...
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
              <a href="#home" class="flex items-center">
                  <img src={logo} class="h-8 w-10 pr-2" alt="Flowbite Logo" />
                  <span class="self-center text-2xl pr-2 font-semibold whitespace-nowrap font-mono text-white">H</span>
                  <span class="self-center text-2xl pr-2 font-semibold whitespace-nowrap font-mono text-blue-500">T</span>
                  <span class="self-center text-2xl pr-2 font-semibold whitespace-nowrap font-mono text-white">E</span>
                  <span class="self-center text-2xl pr-2 font-semibold whitespace-nowrap font-mono text-blue-500">C</span>
                  <span class="self-center text-2xl pr-2 font-semibold whitespace-nowrap font-mono text-white">H</span>
              </a>
          </div>
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  <h2 class="mb-4 text-sm font-semibold text-gray-900 uppercase dark:text-white">Services</h2>
                  <ul class="text-gray-500 dark:text-gray-400 font-medium">
                      <li class="mb-3">
                          <a href="#services" class="hover:underline">Web Developemt</a>
                      </li>
                      <li class="mb-3">
                          <a href="#services" class="hover:underline">UI & UX Designing</a>
                      </li>
                      <li class="mb-3">
                          <a href="#services" class="hover:underline">Bussiness Analytics</a>
                      </li>
                      <li class="mb-3">
                          <a href="#services" class="hover:underline">Digital Marketing</a>
                      </li>
                      <li class="mb-3">
                          <a href="#services" class="hover:underline">General Consulting</a>
                      </li>
                      <li class="mb-3">
                          <a href="#services" class="hover:underline">Mobile App Development</a>
                      </li>
                  </ul>
              </div>
              <div>
                  <h2 class="mb-4 text-sm font-semibold text-gray-900 uppercase dark:text-white">products</h2>
                  <ul class="text-gray-500 dark:text-gray-400 font-medium">
                      <li class="mb-3">
                          <a href="#product" class="hover:underline">Square Workspace</a>
                      </li>
                      <li class="mb-3">
                          <a href="#product" class="hover:underline">ChatBot for Company</a>
                      </li>
                      <li class="mb-3">
                          <a href="#product" class="hover:underline">Centralized AI Tool</a>
                      </li>
                  </ul>
              </div>
              <div>
                  ...
                  <ul class="text-gray-500 dark:text-gray-400 font-medium">
                      ...
                      <li>
                          <a href="#home" class="hover:underline">Terms &amp; Conditions</a>
                      </li>
                  </ul>
              </div>
          </div>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://flowbite.com/" class="hover:underline">HTech</a>. All Rights Reserved.
          </span>
          <div class="flex mt-4 sm:justify-center sm:mt-0">
              <a href="#home" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                  <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 8 19">
                        <path fill-rule="evenodd" d="M6.135 3H8V0H6.135a4.147 4.147 0 0 0-4.142 4.142V6H0v3h2v9.938h3V9h2.021l.592-3H5V3.591A.6.6 0 0 1 5.592 3h.543Z" clip-rule="evenodd"/>
                    </svg>
                  <span class="sr-only">Facebook page</span>
              </a>
              <a href="#home" class="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
